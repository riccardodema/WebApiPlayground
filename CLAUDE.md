...
| Test quality / scrivere o valutare test (mutation testing Stryker via `tests/run-mutation.sh`, coverage gate ratchet + badge, parità DACPAC↔EF, pipeline JWT reale con authority finta, probe strutturali sui rami config-gated) | `.claude/context/testing.md` + `.claude/lessons.md` [L25] [L27] [L28] [L29] |
